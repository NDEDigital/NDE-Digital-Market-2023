...
namespace NDE_Digital_Market.Controllers
{
    ...
    public class ReviewAndRatingController : ControllerBase
    {
        ...
        private readonly IReviewAndRating_Service _ReviewAndRating_Service;
        public ReviewAndRatingController(IReviewAndRating_Service AddToCart_Service)
        {
            _ReviewAndRating_Service = AddToCart_Service;
        }
        ...
        public async Task<IActionResult> getReviewRatingsData(string ProductId)
        {
            try
            {
                if (ProductId == null)
                ...
                object res = await _ReviewAndRating_Service.getReviewRatingsData(ProductId);
                if (res == null)
                {
        ...
        public async Task<IActionResult> AddReview([FromForm] ReviewsAndRatings review)
        {
            try
            {
                ...
                object res = await _ReviewAndRating_Service.AddReview(review);
                return Ok(res);
            }
            catch (Exception ex)
            {
