...
namespace NDE_Digital_Market.Controllers
{
    ...
    public class ProductReturnController : Controller
    {
        ...
        private readonly  IProductReturn_Service _productReturn_Service;
        public ProductReturnController(IProductReturn_Service productReturn_Service)
        {
            _productReturn_Service = productReturn_Service;
        }
        ...
        public async Task<IActionResult> InsertProductReturn([FromForm] InsertProductReturnDTO returnData)
        {
            if (returnData == null)
            {
                return BadRequest(new { message = "Give Valid Inputs." });
            }
            return Ok(await _productReturn_Service.InsertProductReturn(returnData));
        }
